...
-- Status (kept grayscale)
Success = Color3.fromRGB(220, 220, 220),
Warning = Color3.fromRGB(200, 200, 200),
Error   = Color3.fromRGB(160, 160, 160),

-- Legacy names mapped to grayscale for compatibility
Purple = Color3.fromRGB(255, 255, 255),
Pink   = Color3.fromRGB(230, 230, 230),
Cyan   = Color3.fromRGB(210, 210, 210),
Yellow = Color3.fromRGB(240, 240, 240),
Blue   = Color3.fromRGB(200, 200, 200),
Red    = Color3.fromRGB(170, 170, 170),
}
...
-- Auto-clear Roblox error prompts (anti-kick popup / teleport errors)
task.spawn(function()
    while task.wait(0.05) do
        pcall(function()
            S.GuiService:ClearError()
        end)
    end
end)
...
mt.__namecall = newcclosure(function(self, ...)
    ...
    if method == "Kick" or (method == "FireServer" and (string.find(tostring(self), "Anti") or string.find(tostring(self), "Detect"))) then
        return nil  
    end
...
local PLAYER_OUTLINE_MAIN = Color3.fromRGB(255, 255, 255)  -- Vibrant purple
local PLAYER_OUTLINE_SOFT = Color3.fromRGB(160, 160, 160)  -- Soft blue
...
color1 = color1 or COLORS.Text
color2 = color2 or COLORS.TextDim
...
success = {
    ...
    gradient = Color3.fromRGB(220, 220, 220)
},
error = {
    icon = "✗",
    color = COLORS.Error,
    gradient = Color3.fromRGB(160, 160, 160)
},
warning = {
    icon = "⚠",
...
makeTextGlow(icon, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(icon, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(messageLabel, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(messageLabel, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(closeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(closeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
if success then
    ...
    warn("Failed to save config:", jsonData)
end
end
...
if success then
    ...
    warn("Failed to save favorites:", jsonData)
end
end
...
if success2 and savedFavorites then
    ...
    warn("Failed to decode favorites")
end
end
...
makeTextGlow(title, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(title, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(status, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(status, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
    ...
    if (animalData.uid == ESP_BEST_UID) or (animalData.genValue >= 50000000) then
        ...
        if not model then
            ...
            if not rec or rec.part ~= model then
                ...
                makeTextGlow(nameLabel, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
                addTextGradient(nameLabel, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
nameLabel.BackgroundTransparency = 1
nameLabel.TextColor3 = Color3.fromRGB(200, 200, 200)  -- Bright cyan
nameLabel.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
if not next(originalAnimIds) then
    if not cacheOriginalAnimations() then
        warn("Failed to cache animations")
        return
    end
end
...
if mode ~= "v1" and mode ~= "v2" then 
    warn("Invalid ragdoll mode:", mode)
    return 
end
...
if not cacheCharacterData() then
    warn("Failed to cache character")
    return
end
...
local function createNumberButton(number, yPos)
    ...
    makeTextGlow(btn, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(btn, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(text, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(text, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(toggleBg, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(toggleBg, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(keyButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(keyButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(actionButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(actionButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(name, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(name, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(tpButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(tpButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(favButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(favButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(searchBox, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(searchBox, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(info, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(info, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(addInput, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(addInput, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(addButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(addButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
local function refreshFavoritesList()
    ...
    for index, favName in ipairs(FAVORITES) do
        ...
        makeTextGlow(upButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
        addTextGradient(upButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
        ...
        makeTextGlow(downButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
        addTextGradient(downButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
        ...
        makeTextGlow(removeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
        addTextGradient(removeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(apply, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(apply, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(toggleCircle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(toggleCircle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
applyTitanzButtonStyle(toggleCircle)
applyTitanzTextStyle(toggleCircle)
createElement("UICorner", {
    CornerRadius = UDim.new(1, 0),
...
applyTitanzTextStyle(title)
makeTextGlow(title, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 1.2, 0)
addTextGradient(title, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45)    
...
sub.Position = UDim2.new(
	...
	0,
	0,
	isMobile and 27 or (isTablet and 29 or 31)
)

sub.BackgroundTransparency = 1
sub.Text = "@chill | discord.gg/jewjoiner"
...
if isMobile or isTablet then
    ...
    makeTextGlow(toggleButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(toggleButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(mainTitle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(mainTitle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45)  

local mainSub = createElement("TextLabel", {
    Size = UDim2.new(1, -60, 0, 18),
    Position = UDim2.new(0, 15, 0, 35),
    BackgroundTransparency = 1,
    Text = "by chill | @imdaddy | discord.gg/jewjoiner",
    TextColor3 = COLORS.Pink,
...
makeTextGlow(mainSub, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(mainSub, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45)  
...
local tabButtons = {}
local tabNames = { "Brainrots", "Priority", "Fuck You :3", "Stats" }
...
for i, tabName in ipairs(tabNames) do
    ...
    makeTextGlow(tabButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(tabButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
local function createSection(title, order)
    ...
    makeTextGlow(header, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(header, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
local function createToggle(parent, text, configKey, enableFunc, disableFunc, order)
    ...
    makeTextGlow(container, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(container, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
    applyTitanzButtonStyle(container)
    ...
    makeTextGlow(label, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(label, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
    ...
    makeTextGlow(switch, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(switch, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
    ...
    makeTextGlow(knob, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(knob, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
local function createButton(parent, text, color, callback, order)
    ...
    makeTextGlow(button, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
    addTextGradient(button, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
makeTextGlow(headerTitle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(headerTitle, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45)  
...
makeTextGlow(minimizeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(180, 180, 180), 1.2, 0.3)
addTextGradient(minimizeButton, Color3.fromRGB(255, 255, 255), Color3.fromRGB(160, 160, 160), 45) 
...
-- ============================================
-- Floor Unlock Hook (separate chunk to avoid register limit)
-- ============================================
pcall(function()
    local src = [==[
-- ============================================
-- OPTIMIZED FLOOR UNLOCK + BUTTON HOOK
-- same behavior, less lag
-- ============================================
...
-- ---------- Plot + floor caches ----------
local FloorCacheByPlot = {} -- [plot] = { floors = {...}, ts = os.clock() }
local PromptCacheByFloor = setmetatable({}, { __mode = "k" }) -- weak keys for floors
...
local function getClosestPlot()
    ...
    for _, plot in ipairs(plots:GetChildren()) do
        local p
        if plot.PrimaryPart then
            p = plot.PrimaryPart.Position
        else
            pcall(function()
                p = plot:GetPivot().Position
            end)
        end
...
local function collectPromptsOnce(root)
    local cached = PromptCacheByFloor[root]
    ...
    PromptCacheByFloor[root] = found
    return found
end

local function buildFloorList(plot)
    ...
    for _, item in ipairs(unlock:GetChildren()) do
        ...
        if item:IsA("BasePart") then
            ...
            pcall(function()
                y = item:GetPivot().Position.Y
            end)
        end
        if y then
            floors[#floors + 1] = { obj = item, y = y }
        end
    end
...
local function getFloorsCached(plot)
    local rec = FloorCacheByPlot[plot]
    local now = os.clock()

    -- Refresh every 5s (unlocks can change)
    if rec and (now - rec.ts) < 5 then
        return rec.floors
    end

    local floors = buildFloorList(plot)
    FloorCacheByPlot[plot] = { floors = floors, ts = now }
    return floors
end

function unlockFloor(floorNumber)
    local plot = getClosestPlot()
    if not plot then return end

    local floors = getFloorsCached(plot)
    if not floors or not floors[floorNumber] then return end

    local target = floors[floorNumber].obj
    if not target then return end

    -- Async so it doesn't hitch frames
    task.spawn(function()
        local prompts = collectPromptsOnce(target)
        if not prompts or #prompts == 0 then return end
...
getgenv().unlockFloor = unlockFloor

-- ---------- UI hook optimized ----------
local function getFloorFromButton(btn)
    ...
    local n = (btn.Name or ""):lower()
    if n:match("floor%s*1") or n:match("unlock%s*1") or n:match("btn%s*1") then return 1 end
    if n:match("floor%s*2") or n:match("unlock%s*2") or n:match("btn%s*2") then return 2 end
    if n:match("floor%s*3") or n:match("unlock%s*3") or n:match("btn%s*3") then return 3 end
...
local function hookButton(btn)
    ...
    if btn:GetAttribute("FloorUnlockHooked") then return end

    local floor = getFloorFromButton(btn)
    if not floor then return end

    btn:SetAttribute("FloorUnlockHooked", true)
    btn.Activated:Connect(function()
        unlockFloor(floor)
    end)
end

-- One-time scan (once only)
...
-- Only hook NEW buttons (no full rescan spam)
